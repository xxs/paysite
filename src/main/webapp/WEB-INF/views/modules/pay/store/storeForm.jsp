...
<body>
	...
	<form:form id="inputForm" modelAttribute="store" action="${ctx}/pay/store/store/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">门店标志：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="status" items="${fns:getDictList('store_status')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="pay:store:store:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
