...
<body>
	...
	<form:form id="inputForm" modelAttribute="device" action="${ctx}/pay/device/device/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">设备标志：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:radiobuttons path="status" items="${fns:getDictList('device_status')}" itemLabel="label" itemValue="value" htmlEscape="false" class=""/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="pay:device:device:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
