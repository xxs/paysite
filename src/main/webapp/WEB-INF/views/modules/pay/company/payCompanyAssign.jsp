...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/pay/company/payCompany/assign?id=${role.id}"><shiro:hasPermission name="sys:role:edit">商户授权</shiro:hasPermission><shiro:lacksPermission name="sys:role:edit">人员列表</shiro:lacksPermission></a></li>
	</ul>
